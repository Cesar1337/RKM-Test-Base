var RepositoryListController = /** @class */ (function () {
    function RepositoryListController(githubService, searchStateService, tableModificationService) {
    ...
    RepositoryListController.prototype.searchRepositories = function () {
        ...
        if (this.searchTerm !== '') {
            this.loading = true;
            this.githubService.getAllRepositoriesByUsername(this.searchTerm).then(function (response) {
                ...
                _this.errorMessage = _this.searchTerm === '' ?
    ...
    RepositoryListController.prototype.sort = function (sortBy) {
        var _a = this.tableModificationService
            .sortData(this.userRepositories, sortBy), sortedData = _a.sortedData, sortAscent = _a.sortAscent, sortedProperty = _a.sortedProperty;
